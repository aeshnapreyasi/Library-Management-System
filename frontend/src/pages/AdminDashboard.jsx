...
import { Settings, FileText, ArrowRight, ArrowLeft, Banknote, UserPlus, BookPlus, LogOut, LayoutDashboard } from 'lucide-react';
import AddCatalogItem from '../components/modules/AddCatalogItem';
import ManageMembership from '../components/modules/ManageMembership';
...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: 'add-book', label: 'Add Book/Movie', icon: <BookPlus size={20} />, category: 'Maintenance' },
    { id: 'add-member', label: 'Add Membership', icon: <UserPlus size={20} />, category: 'Maintenance' },
    ...
    <div className="flex h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 mt-4">
      ...
      <aside className="w-64 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col overflow-y-auto">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-bold text-blue-600 dark:text-blue-400">Admin Portal</h2>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <button onClick={logout} className="w-full flex items-center space-x-3 px-4 py-3 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
            <LogOut size={20} />
        ...
        <div className="animate-in fade-in duration-300">
          {activeTab === 'overview' && (
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">Select a module from the sidebar to manage the library system.</p>
            </div>
          )}
